...
Welcome to my **Introduction to Bioinformatics** repository! This repo contains all notes, assignments, scripts, and projects from my journey through the bioinformatics.

## 📚 Course Overview

This course provides a foundational introduction to the interdisciplinary field of bioinformatics, combining biology, biotechnology, and biostatistics. Topics covered include.
